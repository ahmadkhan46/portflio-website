  ...
  return (
    ...
    >
        ...
        <div className='space-y-10 px-0 md:px-10'>
            ...
            <p className='text-base md:text-left'>
                <span className='text-gray-400'>I'm Ahmad Said Khan,</span><br/>
                I am Ahmad Said Khan, a passionate Full Stack Developer 
                specializing in Next.js and React. I hold a
                B.Tech in Computer Science and am currently pursuing an
                MSc in Software Design with Artificial Intelligence at
                TU Shannon, Ireland.
