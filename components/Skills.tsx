...
const items = [{
  ...
  {
    id:4,
    img: 'https://cdn1.iconfinder.com/data/icons/akar-vol-1/24/nextjs-fill-256.png',
    progress:80,
  },
  {
    id:5,
  ...
  {
    id:8,
    img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGEpRzlK3b4Eh-Dddp3gvO3LLyIaERE2yw4kPVAVM-MA&s',
    progress:75,
  },
]
...
function Skills() {
  return (
    ...
    items-center md:text-left xl:flex-row max-w-[2000px] xl:px:10
